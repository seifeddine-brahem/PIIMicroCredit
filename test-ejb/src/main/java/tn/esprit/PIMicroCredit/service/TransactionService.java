...
public class TransactionService implements ITransactionRemote {
	...
	public List<Transaction> findtransfer() {
		List<Transaction> emp = em.createQuery("Select e from Transaction e where e.transaction_type ='transfer'",Transaction.class).getResultList();
		return emp;
	}
	...
	public List<Transaction> findwithdrawal() {
		List<Transaction> emp = em.createQuery("Select e from Transaction e where e.transaction_type ='withdrawal'",Transaction.class).getResultList();
		return emp;
	}
